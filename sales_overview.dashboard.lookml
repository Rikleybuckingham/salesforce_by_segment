- dashboard: sales_overview
  ...
  - name: New - Closed/Won Opportunities QTD
    ...
    - 'palette: Mixed Dark'
    series_colors:
      sf__opportunities.bookings_value: "#a6cee3"
      sf__opportunities.sum_of_bookings_value: "#33a02c"
    listen:
      Opportunity Owner: opportunity_owners.name
    row: 8
    col: 0
  ...
  - name: New - Upside Opportunities QTD
    ...
    series_colors:
      sf__opportunities.bookings_value: "#a6cee3"
      sf__opportunities.sum_of_bookings_value: "#a6cee3"
    listen:
      Opportunity Owner: opportunity_owners.name
    row: 15
    col: 12
  ...
  - name: New - Forecast Opportunities QTD
    ...
    series_colors:
      sf__opportunities.bookings_value: "#a6cee3"
      sf__opportunities.sum_of_bookings_value: "#1f78b4"
    listen:
      Opportunity Owner: opportunity_owners.name
    row: 15
    col: 0
  ...
  - name: New - Commit Opportunities QTD
    ...
    series_colors:
      sf__opportunities.bookings_value: "#a6cee3"
      sf__opportunities.sum_of_bookings_value: "#b2df8a"
    listen:
      Opportunity Owner: opportunity_owners.name
    row: 8
    col: 12
